...
export function createLspNavigationTool(getFlag) {
    return {
        ...
        async execute(_toolCallId, params, _signal, _onUpdate, ctx) {
            ...
            const { operation: rawOperation, filePath: rawPath, line, character, symbol, endLine, endCharacter, newName, newFilePath, apply, query, kinds, exactMatch, topLevelOnly, maxResults, callHierarchyItem, } = params;
