...
function packageHasEslintDependency(pkg) {
...
export const EslintRoot = async (file) => {
...
export const PythonJediServer = {
    ...
    async spawn(root) {
        try {
            ...
            const pythonPath = await detectPythonVenv(root);
            const initialization = pythonPath
...
export const RubySolargraphServer = {
    id: "ruby-solargraph",
    name: "Solargraph",
    extensions: KIND_EXTENSIONS["ruby"],
    root: RootWithFallback(PriorityRoot([["Gemfile", ".ruby-version"], [".git"]])),
