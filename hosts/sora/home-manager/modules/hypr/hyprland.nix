    ...
    extraConfig =
      ...
      */
      ''
        ...
        hl.animation({ leaf = "fadeLayersIn", enabled = true, speed = 5, bezier = "easeout" })
        hl.animation({ leaf = "fadeOut", enabled = true, speed = 3, bezier = "easeout" })
        hl.animation({ leaf = "fadeLayersOut", enabled = true, speed = 5, bezier = "easeout" })
        ...
        ------------------------------- MONITORS -------------------------------
        hl.monitor({ output = "DP-1", mode = "3440x1440@165.00", position = "0x0", scale= 1 })
        hl.monitor({ output = "DP-2", mode = "1920x1080@120", position = "3440x0", scale = 1, transform = 1 })
        hl.monitor({ output = "HDMI-A-1", mode = "highres", position = "-3440x0", scale= 1 })
        ------------------------------------------------------------------------
