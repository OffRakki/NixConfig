...
| `hosts/sora/home-manager/modules/pi/context.md` | Ciel-personality, pi-specific tool-discipline(read,bash,edit,write,grep,find,ls), skill-routing(pi-tools), nix-managed, sops-refs, speak-up-rule, read-before-write, keep-index-in-sync, subagents-list |
