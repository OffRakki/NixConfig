...
export class TreeSitterFixer {
     ...
     */
    calculateFix(filePath, nodeRange, nodeText, template, captures) {
        switch (template.action) {
            case "remove":
                return this.calculateRemove(filePath, nodeRange, nodeText);
            case "replace":
                return this.calculateReplace(filePath, nodeRange, nodeText, template, captures);
            case "wrap":
                return this.calculateWrap(filePath, nodeRange, nodeText, template, captures);
            default:
                return null;
        }
    }
     ...
     */
    calculateRemove(filePath, nodeRange, nodeText) {
        return {
            filePath,
     ...
     */
    calculateReplace(filePath, nodeRange, nodeText, template, captures) {
     ...
     */
    calculateWrap(filePath, nodeRange, nodeText, template, captures) {
    ...
    editsOverlap(edit1, edit2) {
        ...
        return !(edit1.endLine < edit2.startLine || edit2.endLine < edit1.startLine);
    }
    /**
