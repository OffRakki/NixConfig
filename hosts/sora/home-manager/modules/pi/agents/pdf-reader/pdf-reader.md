...
1. **Set up**: `mkdir -p /tmp/pi/pdf-images && rm -f /tmp/pi/pdf.txt`
2. **Convert to images**: `nix shell nixpkgs#poppler-utils -c pdftoppm -jpeg -r 50 <pdf_path> /tmp/pi/pdf-images/page`
