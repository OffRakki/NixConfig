...
function toFullPlan(kind, entry) {
    if (kind === "jsts") {
...
export const FULL_LINT_PLANS = Object.fromEntries(Object.entries(LANGUAGE_CAPABILITY_MATRIX).map(([kind, entry]) => [
    kind,
    toFullPlan(kind, entry),
]));
